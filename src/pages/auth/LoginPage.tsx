      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Hesabınıza giriş yaparak modüllere erişin
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-xl p-8">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to="/auth/forgot-password" className="font-medium text-pest-green-600 hover:text-pest-green-500">
                  Şifremi unuttum
                </Link>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Hesabınız yok mu?{' '}
              <Link to="/auth/register" className="font-medium text-pest-green-600 hover:text-pest-green-500">
                Kayıt Ol
              </Link>
            </p>
          </div>
